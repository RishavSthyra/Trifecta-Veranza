...
const DRAG_MAX_LEAD_FRAMES = 6;
const DRAG_PROGRESS_LERP_FORWARD = 0.2;
const DRAG_PROGRESS_LERP_BACKWARD = 0.25;
const DRAG_PROGRESS_DIRECT_COMMIT_THRESHOLD = 0.012;
