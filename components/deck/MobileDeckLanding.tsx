...
export default function MobileDeckLanding() {
  ...
  return (
    <div className="w-full px-1.5 sm:px-2.5 md:px-3 lg:px-4 xl:mx-auto xl:max-w-full  xl:px-0">
              ...
              >
                <defs>
                  <linearGradient
                    ...
                    y2="1"
                  >
                    <stop offset="0%" stopColor="#ab5f68" stopOpacity={0.38} />
                    <stop offset="100%" stopColor="#ab5f68" stopOpacity={0.05} />
                  </linearGradient>
                </defs>
                <CartesianGrid
                  stroke="#e7ddcf"
                ...
                <div className="mt-3 grid grid-cols-2 gap-2">
                  <div className="rounded-[16px] border border-white/14 bg-white/8 p-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[12px] font-medium">{plan.bhk}</span>
                    </div>
                  </div>
      ...
      {/* END */}
      <section className="border-t border-white/35 px-4 py-8 text-center sm:px-6 sm:py-12">
        ...
        <p className="mt-4 text-[10px] uppercase tracking-[0.38em] text-[#8a7562]">
          Off Sarjapur Road
        </p>
